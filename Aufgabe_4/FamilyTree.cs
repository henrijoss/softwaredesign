...
namespace Debugging
{
    ...
    public class Familytree
    {
        ...
        {
            int alter = DateTime.Now.Year - person.DateOfBirth.Year;
            Person ret = null;
            //if (person.FirstName != "Willi") //If first Name is not Willi
            //if (person.LastName == "Spencer") //If last name is Spencer
            //if (alter >= 50)//If the person is 50 years or older
            //if (alter == 20 || alter == 40)//if the person is 20 or 40 years old
            if (alter > 40 && alter < 90)//if the person is between 40 and 90 years old
                return person;
